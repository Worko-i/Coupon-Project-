...
public interface CouponService {
    ...
    List<CouponDTO> getCouponsByCategory(CategoryType category) throws AuthorizationException;
    ...
    List<CouponDTO> getAllCouponsByCompanyIdAndCategory(int companyId, CategoryType category) throws AuthorizationException;
